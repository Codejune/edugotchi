...
public class SubjectListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        subject_timeout = view.findViewById(R.id.subject_timeout);

        /* MyItem에 아이템을 setting한다. */
        subject_title.setText(subjects.get(position).getSubject());
        subject_timeout.setText(String.format("%02d : %02d : %02d", timeout/1000/60/60, timeout/1000/60%60, timeout/1000%60%60));
